...
class Заказ:
    ...
    def __str__(self):
        ...
        for i in range(len(self.заказанные_пиццы)):
            res += f"{i + 1}. {str(self.заказанные_пиццы[i])}\n"
    ...
    def сумма(self):
        ...
        return sum([i.цена for i in self.заказанные_пиццы])
    ...
    def выполнить(self):
        ...
        for i in range(len(self.заказанные_пиццы)):
            print(f"{i + 1}. {self.заказанные_пиццы[i].название}")
            print(self.заказанные_пиццы[i].подготовить())
            time.sleep(1)
            print(self.заказанные_пиццы[i].испечь())
            time.sleep(1)
            print(self.заказанные_пиццы[i].нарезать())
            time.sleep(1)
            print(self.заказанные_пиццы[i].упаковать())
            time.sleep(1)
